...
namespace Company.Web.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> AddORemoveUser(string roleId)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> AddORemoveUser(string roleId, List<UserInRoleViewModel> users)
        {
            var role = await _roleManager.FindByIdAsync(roleId);
